...
local function addSectionTitle(text, parent, order)
    ...
    label({Text = text, Font = Enum.Font.GothamBold, TextSize = 11, TextColor3 = C.white,
...
local function addToggleRow(titleText, subText, parent, order, callback)
    ...
    label({Text = titleText, Font = Enum.Font.GothamSemibold, TextSize = 12, TextColor3 = C.text,
    ...
    if subText then
        label({Text = subText, Font = Enum.Font.Gotham, TextSize = 9, TextColor3 = C.sub,
    ...
    row.MouseEnter:Connect(function() tween(row, 0.08, {BackgroundColor3 = C.itemHov}) end)
    row.MouseLeave:Connect(function() tween(row, 0.08, {BackgroundColor3 = C.item}) end)
    return setToggle
end
...
local function addTpButton(titleText, coords, dotColor, parent, order, callback)
    ...
    label({Text = titleText, Font = Enum.Font.GothamSemibold, TextSize = 11, TextColor3 = C.text,
        Size = UDim2.new(0.55, -20, 1, 0), Position = UDim2.new(0, 22, 0, 0),
        TextXAlignment = Enum.TextXAlignment.Left}, btn)
    label({Text = coords, Font = Enum.Font.Code, TextSize = 9, TextColor3 = C.sub,
...
for _, d in ipairs({{"Version", "v3.0 Premium"}, {"Executor", "Delta"}}) do
    ...
    label({Text = d[1], Font = Enum.Font.Gotham, TextSize = 10, TextColor3 = C.sub,
        Size = UDim2.new(1,-16,0,14), Position = UDim2.new(0,8,0,6)}, card)
    label({Text = d[2], Font = Enum.Font.GothamBold, TextSize = 12, TextColor3 = C.accent2,
...
label({Text = "FPS Booster", Font = Enum.Font.GothamSemibold, TextSize = 12, TextColor3 = C.text,
