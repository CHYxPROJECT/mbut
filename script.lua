...
flagsBtn.MouseButton1Click:Connect(function()
    ...
    -- Aplicar cada flag usando setfflag (soportado por Delta y la mayoría de executors)
    local flags = {
    ...
    if ok then
        ...
        flagSubLabel.Text = "✓ Aplicadas · Rejoin para quitar"
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "Rivals · Performance",
            Text = "Flags aplicadas correctamente",
            Duration = 3,
        })
    else
        flagSubLabel.Text = "✗ Error: executor no soporta setfflag"
